class RokAdBlocker {
    constructor() {
        ...
        this.adSelectors = [
            ...
            '.ok-details-adv-in-right',
            '.ok-details-adv-in-center',
            '.ok-details-adv-in-bottom',
            '.ok-details-adv-in-top',
            '.ok-details-adv-in-left-top',
            '.ok-details-adv-in-left-bottom',
            '.ok-details-adv-in-right-top',
            '#google_ads_iframe',
            '.google-ad-unit',
            '.ok-hot-topics-top',
            '.ok-full-widht-adv',
